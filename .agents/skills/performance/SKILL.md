...
```
`moderate` triggers after a ~200ms hover — usually intent-correlated, rarely wasted. See [core-web-vitals → LCP](../../../apm_modules/addyosmani/web-quality-skills/skills/core-web-vitals/SKILL.md#lcp-largest-contentful-paint) for the full discussion of eagerness tradeoffs and the `prerenderingchange` gating you'll need for analytics.
...
For Core Web Vitals specific optimizations, see [Core Web Vitals](../../../apm_modules/addyosmani/web-quality-skills/skills/core-web-vitals/SKILL.md).
