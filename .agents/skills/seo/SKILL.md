...
| Technical SEO | ~15% | ✓ |
| Page experience (Core Web Vitals) | ~10% | See [Core Web Vitals](../../../apm_modules/addyosmani/web-quality-skills/skills/core-web-vitals/SKILL.md) |
| On-page SEO | ~10% | ✓ |
...
- [Web Quality Audit](../../../apm_modules/addyosmani/web-quality-skills/skills/web-quality-audit/SKILL.md)
