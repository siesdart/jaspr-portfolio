...
class OpensourceMapper extends ClassMapperBase<Opensource> {
  ...
  static const Field<Opensource, String> _f$description =
  ...
  static const Field<Opensource, List<Contribution>> _f$contribution =
      Field('contribution', _$contribution, opt: true);
...
mixin OpensourceMappable {
  String toJson() {
    return OpensourceMapper.ensureInitialized()
        .encodeJson<Opensource>(this as Opensource);
  }

  Map<String, dynamic> toMap() {
    return OpensourceMapper.ensureInitialized()
        .encodeMap<Opensource>(this as Opensource);
  }

  OpensourceCopyWith<Opensource, Opensource, Opensource> get copyWith =>
      _OpensourceCopyWithImpl(this as Opensource, $identity, $identity);
  @override
  String toString() {
    return OpensourceMapper.ensureInitialized()
        .stringifyValue(this as Opensource);
  }

  @override
  bool operator ==(Object other) {
    return OpensourceMapper.ensureInitialized()
        .equalsValue(this as Opensource, other);
  }
...
extension OpensourceValueCopy<$R, $Out>
  ...
  OpensourceCopyWith<$R, Opensource, $Out> get $asOpensource =>
      $base.as((v, t, t2) => _OpensourceCopyWithImpl(v, t, t2));
}

abstract class OpensourceCopyWith<$R, $In extends Opensource, $Out>
    implements ClassCopyWith<$R, $In, $Out> {
  ListCopyWith<$R, Contribution,
      ContributionCopyWith<$R, Contribution, Contribution>>? get contribution;
  $R call(
      {String? repo,
      String? description,
      String? role,
...
class _OpensourceCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<$R, Contribution,
      ...
      get contribution => $value.contribution != null
          ? ListCopyWith($value.contribution!, (v, t) => v.copyWith.$chain(t),
  ...
  OpensourceCopyWith<$R2, Opensource, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _OpensourceCopyWithImpl($value, $cast, t);
}
...
class ContributionMapper extends ClassMapperBase<Contribution> {
  ...
  static const Field<Contribution, String> _f$description =
      Field('description', _$description);
  static String? _$title(Contribution v) => v.title;
  static const Field<Contribution, String> _f$title =
...
mixin ContributionMappable {
  String toJson() {
    return ContributionMapper.ensureInitialized()
        .encodeJson<Contribution>(this as Contribution);
  }

  Map<String, dynamic> toMap() {
    return ContributionMapper.ensureInitialized()
        .encodeMap<Contribution>(this as Contribution);
  }

  ContributionCopyWith<Contribution, Contribution, Contribution> get copyWith =>
      _ContributionCopyWithImpl(this as Contribution, $identity, $identity);
  @override
  String toString() {
    return ContributionMapper.ensureInitialized()
        .stringifyValue(this as Contribution);
  }

  @override
  bool operator ==(Object other) {
    return ContributionMapper.ensureInitialized()
        .equalsValue(this as Contribution, other);
  }

  @override
  int get hashCode {
    return ContributionMapper.ensureInitialized()
        .hashValue(this as Contribution);
  }
}
...
extension ContributionValueCopy<$R, $Out>
  ...
  ContributionCopyWith<$R, Contribution, $Out> get $asContribution =>
      $base.as((v, t, t2) => _ContributionCopyWithImpl(v, t, t2));
}
...
class _ContributionCopyWithImpl<$R, $Out>
  ...
  late final ClassMapperBase<Contribution> $mapper =
      ContributionMapper.ensureInitialized();
  @override
  $R call({int? id, String? description, Object? title = $none}) =>
      $apply(FieldCopyWithData({
        if (id != null) #id: id,
        if (description != null) #description: description,
  ...
  ContributionCopyWith<$R2, Contribution, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _ContributionCopyWithImpl($value, $cast, t);
}
